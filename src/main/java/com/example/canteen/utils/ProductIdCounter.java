...
public class ProductIdCounter {
    private static final String TABLE_NAME = "ProductIdCounter";
    private static final String COUNTER_ATTRIBUTE = "ProductIdCounter";

    public Integer getNextProductId(final DynamoDbClient dynamoDbClient) {
